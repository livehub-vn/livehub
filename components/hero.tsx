  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-5 border-b border-white/10 px-4 py-3 sm:px-6">
        ...
        <span className="bg-accent rounded-lg px-3 py-2 text-xs font-medium text-neutral-950">
          Đăng nhu cầu
        </span>
      </div>
    ...
    >
      ...
      >
        <div className="relative mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-2xl border border-neutral-200 mask-[linear-gradient(to_bottom,black_58%,transparent_100%)] shadow-2xl/5 [-webkit-mask-image:linear-gradient(to_bottom,black_58%,transparent_100%)]">
            <MarketplacePreview />
          </div>
        </div>
      </motion.div>
